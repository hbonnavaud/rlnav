...
def generate_video(images, output_directory: str = ".", filename="video", convert_to_bgr=True):
    """
...
def save_image(image: np.ndarray, output_directory: str = ".", file_name: str = "image", extension: str = "png"):
    directory_path = os.path.abspath(output_directory)
    directory_path += os.path.sep
